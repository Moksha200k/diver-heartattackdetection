...
def d_dtcn():
	...
	def function1():
		os.system("python heartattack_detection.py --shape_predictor shape_predictor_68_face_landmarks.dat")
		exit()
	...
	root.title("HEARTATTACK DETECTION")
	Label(root, text="HEARTATTACK DETECTION",font=("times new roman",20),fg="black",bg="aqua",height=2).grid(row=2,rowspan=2,columnspan=5,sticky=N+E+W+S,padx=5,pady=10)
