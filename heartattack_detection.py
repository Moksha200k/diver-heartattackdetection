...
ap.add_argument("-p", "--shape_predictor", required=True,
                help="C:\\Users\\Moksha\\OneDrive\\Desktop\\diver-heartattackdetection")
    ...
    for (i, rect) in enumerate(rects):
        ...
        if EAR < EAR_THRESHOLD:
            ...
            if FRAME_COUNT >= CONSECUTIVE_FRAMES:
                ...
                playsound(
                    'C:\\Users\\Moksha\\OneDrive\\Desktop\\diver-heartattackdetection\\sound_files\\heartattack.mp3')
                cv2.putText(frame, "HEARTATTACK ALERT!", (270, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        else:
            if FRAME_COUNT >= CONSECUTIVE_FRAMES:
                playsound(
                    'C:\\Users\\Moksha\\OneDrive\\Desktop\\diver-heartattackdetection\\sound_files\\heartattack.mp3')
        ...
        if MAR > MAR_THRESHOLD:
            ...
            playsound('C:\\Users\\Moksha\\OneDrive\\Desktop\\diver-heartattackdetection\\sound_files\\heartattack.mp3')
            playsound('C:\\Users\\Moksha\\OneDrive\\Desktop\\diver-heartattackdetection\\sound_files\\heartattack.mp3')
